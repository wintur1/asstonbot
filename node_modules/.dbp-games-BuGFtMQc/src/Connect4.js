...
module.exports = class Connect4Game {
    constructor(options = {}) {
        ...
        if (!options.askMessage) options.askMessage = 'Hey {opponent}, {challenger} Wyzywa cię na pojedynek 4 pod rząd!';
    ...
    async startGame() {
        ...
        if (this.opponent.id === this.message.author.id) return this.sendMessage('Nie mozesz zagrać z sasmym sobą!')
