...
module.exports = class RPSGame {
    ...
    async startGame() {
        ...
        if (this.opponent.bot) return this.sendMessage('Nie mozesz zagrać z botem!')
        if (this.opponent.id === this.message.author.id) return this.sendMessage('Nie mozesz zagrać z samym sobą!')
